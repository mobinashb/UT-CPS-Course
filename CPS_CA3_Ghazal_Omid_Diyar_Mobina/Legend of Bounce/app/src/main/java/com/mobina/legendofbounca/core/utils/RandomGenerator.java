...
public final class RandomGenerator {
    ...
    public static _3dVector random3dVector(double xLow, double xHigh,
                                           double yLow, double yHigh,
                                           double zLow, double zHigh){
        return new _3dVector(generateRandomNum(xLow, xHigh),
            generateRandomNum(yLow, yHigh),
            generateRandomNum(zLow, zHigh));
    }
